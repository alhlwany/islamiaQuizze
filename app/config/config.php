...
defined('DATABASE_DB_NAME')?  null :define('DATABASE_DB_NAME','stor');
...
defined('CHECK_FOR_PRIVILEGES') ? null : define('CHECK_FOR_PRIVILEGES', 1);// ... 0 no work to perm    ... 1 work with perm
